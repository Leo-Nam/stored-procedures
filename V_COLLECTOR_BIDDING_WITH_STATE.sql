...
VIEW `chiumdev_2`.`V_COLLECTOR_BIDDING_WITH_STATE` AS
    SELECT 
        ...
        `chiumdev_2`.`A`.`COLLECTOR_STATUS_CODE` AS `COLLECTOR_STATUS_CODE`,
        `chiumdev_2`.`A`.`COLLECTOR_STATUS_NM_KO` AS `COLLECTOR_STATUS_NM_KO`,
        `chiumdev_2`.`A`.`COLLECTOR_STATUS_NM_EN` AS `COLLECTOR_STATUS_NM_EN`,
        ...
        `chiumdev_2`.`A`.`COLLECTOR_REJECT_DECISION` AS `COLLECTOR_REJECT_DECISION`,
        ...
        `chiumdev_2`.`A`.`COLLECTOR_REJECTED_AT` AS `COLLECTOR_REJECTED_AT`,
