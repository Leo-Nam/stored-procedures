...
*/
	...
	SELECT 
        ...
        A.STATE_CATEGORY, 
        A.STATE_CATEGORY_ID, 
        A.COLLECTOR_CATEGORY, 
        A.COLLECTOR_CATEGORY_ID, 
        A.DISPOSER_NOTE, 
        A.DISPOSER_CLOSE_AT,
        A.DISPOSER_KIKCD_B_CODE,
        A.DISPOSER_SI_DO,
        A.DISPOSER_SI_GUN_GU,
        A.DISPOSER_EUP_MYEON_DONG,
        A.DISPOSER_DONG_RI,
        A.DISPOSER_ADDR,
        A.DISPOSER_LAT,
        A.DISPOSER_LNG
	...
	WHERE 
		A.COLLECTOR_CATEGORY_ID = IN_STATE_CODE AND 
        B.ID = IN_USER_ID AND
        B.ACTIVE = TRUE;
	...
	CREATE TEMPORARY TABLE IF NOT EXISTS CURRENT_STATE_BY_OPTION (
		...
		COLLECTOR_STATE_CATEGORY_ID		INT,
		COLLECTOR_STATE_CATEGORY		VARCHAR(10)
	);        
	...
	cloop: LOOP
		...
		CURRENT_STATE_BY_OPTION(
			...
			STATE_CATEGORY, 
			STATE_CATEGORY_ID, 
			COLLECTOR_STATE_CATEGORY, 
			COLLECTOR_STATE_CATEGORY_ID, 
			DISPOSER_NOTE, 
			DISPOSER_CLOSE_AT,
	...
	SELECT JSON_ARRAYAGG(JSON_OBJECT(
        ...
        'COLLECTOR_STATE_CATEGORY'			, COLLECTOR_STATE_CATEGORY, 
        'COLLECTOR_STATE_CATEGORY_ID'		, COLLECTOR_STATE_CATEGORY_ID
	)) 
