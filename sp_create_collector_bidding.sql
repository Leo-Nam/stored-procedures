...
BEGIN
    ...
    SELECT COUNT(ID) INTO @ALREADY_BIDDING FROM COLLECTOR_BIDDING WHERE COLLECTOR_ID = IN_COLLECTOR_SITE_ID AND DISPOSAL_ORDER_ID = IN_DISPOSER_ORDER_ID AND ACTIVE = IN_ACTIVE;
