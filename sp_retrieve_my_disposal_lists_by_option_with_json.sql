...
*/
	...
	CREATE TEMPORARY TABLE IF NOT EXISTS DISPOSAL_ORDER (
	...
	cloop: LOOP
        ...
        LEFT JOIN STATUS B ON A.STATE_CODE = B.ID
        WHERE 
			DISPOSER_ORDER_ID 		= CUR_DISPOSER_ORDER_ID AND 
            COLLECTOR_CANCEL_VISIT IS NOT TRUE AND 
            B.PID <> 211;
    ...
    ELSE
		...
		SET msg_txt 				= 'Success';
    END IF;
	DROP TABLE IF EXISTS DISPOSAL_ORDER;
END