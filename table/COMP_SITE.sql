CREATE TABLE `COMP_SITE` (
  ...
  `KIKCD_B_CODE` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '사이트가 소재하는 주소의 시군구코드(KIKCD_B_CODE)',
  `ADDR` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '사이트가 소재하는 주소의 시군구 주소를 제외한 상세주소',
  `CONTACT` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `LAT` decimal(12,9) DEFAULT NULL,
  `LNG` decimal(12,9) DEFAULT NULL,
  `SITE_NAME` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '개설 사이트 이름',
  `ACTIVE` tinyint NOT NULL DEFAULT '1' COMMENT '사이트의 활성화 상태로서 1인 경우 활성화 되어 있는 경우이고 0인 경우에는 비활성화되어 있는 상태임',
  `TRMT_BIZ_CODE` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
